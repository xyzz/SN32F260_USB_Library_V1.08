...
extern	volatile uint32_t	wUSB_EPnOffset[4];
extern	volatile uint32_t	wUSB_EPnPacketsize[5];
extern	volatile uint8_t		wUSB_EndpHalt[5];

extern	const	uint8_t	*pUSB_TableIndex;
extern	volatile uint32_t	wUSB_TableLength;
extern	volatile uint8_t	wUSB_IfAlternateSet[4];
