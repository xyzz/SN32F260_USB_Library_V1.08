...
#define HID_ReportDescSize2 sizeof(HID_ReportDescriptor2)
...
#define HID_ReportDescSize3 sizeof(HID_ReportDescriptor3)
...
#define HID_ReportDescSize4 sizeof(HID_ReportDescriptor4)
